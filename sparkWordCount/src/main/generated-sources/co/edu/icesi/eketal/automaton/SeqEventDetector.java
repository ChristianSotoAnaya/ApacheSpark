...
public class SeqEventDetector {
  ...
  private void initialize() {
    ...
    Transition initialStateMostrar6 = new Transition(estados.get(estadoInitialState), estados.get(estadoLlegada), mapping.get(nombreEvento));
    transitionSet.add(initialStateMostrar6);
